...
def transform_old_to_new(old_data):
    ...
    for privacy in old_data["privacy_types"]:
        ...
        privacy_type_description_mapping = {
            "DATA_LINKED_TO_YOU": "The following data, which may be collected and linked to your identity, may be used for the following purposes:",
            "DATA_NOT_LINKED_TO_YOU": "The following data, which may be collected but is not linked to your identity, may be used for the following purposes:",
            "DATA_NOT_COLLECTED": "The developer does not collect any data from this app.",
            "DATA_USED_TO_TRACK_YOU": "The following data may be used to track you across apps and websites owned by other companies:"
        }
        ...
        for purpose in privacy["purposes"]:
            for data_category in purpose["datacategories"]:
                ...
                data_category_info = {
                    ...
                    "dataTypes": [data_type["data_type"] for data_type in data_category["datatypes"]]
                }
